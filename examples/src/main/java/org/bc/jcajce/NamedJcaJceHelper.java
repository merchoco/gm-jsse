...
public class NamedJcaJceHelper implements JcaJceHelper {
   ...
   public CertificateFactory createCertificateFactory(String var1) throws NoSuchAlgorithmException, CertificateException, NoSuchProviderException {
