...
import org.bc.crypto.generators.ElGamalParametersGenerator;
...
public class AlgorithmParameterGeneratorSpi extends java.security.AlgorithmParameterGeneratorSpi {
   ...
   protected AlgorithmParameters engineGenerateParameters() {
      ...
      try {
         AlgorithmParameters var3 = AlgorithmParameters.getInstance("ElGamal", BouncyCastleProvider.PROVIDER_NAME);
