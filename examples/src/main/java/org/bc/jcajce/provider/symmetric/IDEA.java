...
import org.bc.asn1.misc.IDEACBCPar;
import org.bc.crypto.BlockCipher;
import org.bc.crypto.CipherKeyGenerator;
import org.bc.crypto.engines.IDEAEngine;
...
import org.bc.jcajce.provider.symmetric.util.PBESecretKeyFactory;
...
public final class IDEA {
   public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
      ...
      protected AlgorithmParameters engineGenerateParameters() {
         ...
         try {
            AlgorithmParameters var2 = AlgorithmParameters.getInstance("IDEA", BouncyCastleProvider.PROVIDER_NAME);
   ...
   public static class Mappings extends AlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         ...
         var1.addAlgorithm("Cipher.1.3.6.1.4.1.188.7.1.1.2", PREFIX + "$CBC");
         var1.addAlgorithm("Cipher.PBEWITHSHAANDIDEA-CBC", PREFIX + "$PBEWithSHAAndIDEA");
         var1.addAlgorithm("KeyGenerator.IDEA", PREFIX + "$KeyGen");
         var1.addAlgorithm("KeyGenerator.1.3.6.1.4.1.188.7.1.1.2", PREFIX + "$KeyGen");
