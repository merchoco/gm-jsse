...
import org.bc.crypto.engines.RC532Engine;
import org.bc.crypto.engines.RC564Engine;
...
public final class RC5 {
   public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
      ...
      protected AlgorithmParameters engineGenerateParameters() {
         ...
         try {
            AlgorithmParameters var2 = AlgorithmParameters.getInstance("RC5", BouncyCastleProvider.PROVIDER_NAME);
