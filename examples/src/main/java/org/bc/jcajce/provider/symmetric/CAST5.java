...
import org.bc.asn1.misc.CAST5CBCParameters;
import org.bc.crypto.BlockCipher;
import org.bc.crypto.CipherKeyGenerator;
import org.bc.crypto.engines.CAST5Engine;
...
public final class CAST5 {
   public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
      ...
      protected AlgorithmParameters engineGenerateParameters() {
         ...
         try {
            AlgorithmParameters var2 = AlgorithmParameters.getInstance("CAST5", BouncyCastleProvider.PROVIDER_NAME);
   ...
   public static class Mappings extends AlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         ...
         var1.addAlgorithm("Cipher.1.2.840.113533.7.66.10", PREFIX + "$CBC");
         var1.addAlgorithm("KeyGenerator.CAST5", PREFIX + "$KeyGen");
         var1.addAlgorithm("Alg.Alias.KeyGenerator.1.2.840.113533.7.66.10", "CAST5");
      }
   }
}
