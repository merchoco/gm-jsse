...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   protected KeySpec engineGetKeySpec(Key var1, Class var2) throws InvalidKeySpecException {
      ...
      if (var2.isAssignableFrom(ECPublicKeySpec.class) && var1 instanceof ECPublicKey) {
         ...
         } else if (var2.isAssignableFrom(org.bc.jce.spec.ECPublicKeySpec.class) && var1 instanceof ECPublicKey) {
            var5 = (ECPublicKey)var1;
            if (var5.getParams() != null) {
               return new org.bc.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(var5.getParams(), var5.getW(), false), EC5Util.convertSpec(var5.getParams(), false));
            } else {
               var4 = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
               return new org.bc.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(var5.getParams(), var5.getW(), false), var4);
            }
         } else if (var2.isAssignableFrom(org.bc.jce.spec.ECPrivateKeySpec.class) && var1 instanceof ECPrivateKey) {
            var3 = (ECPrivateKey)var1;
            if (var3.getParams() != null) {
               return new org.bc.jce.spec.ECPrivateKeySpec(var3.getS(), EC5Util.convertSpec(var3.getParams(), false));
            } else {
               var4 = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
               return new org.bc.jce.spec.ECPrivateKeySpec(var3.getS(), var4);
            }
         } else {
   ...
   protected PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof org.bc.jce.spec.ECPrivateKeySpec) {
         return new BCECPrivateKey(this.algorithm, (org.bc.jce.spec.ECPrivateKeySpec)var1, this.configuration);
      } else {
   ...
   protected PublicKey engineGeneratePublic(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof org.bc.jce.spec.ECPublicKeySpec) {
         return new BCECPublicKey(this.algorithm, (org.bc.jce.spec.ECPublicKeySpec)var1, this.configuration);
      } else {
         return (PublicKey)(var1 instanceof ECPublicKeySpec ? new BCECPublicKey(this.algorithm, (ECPublicKeySpec)var1, this.configuration) : super.engineGeneratePublic(var1));
      }
   }
