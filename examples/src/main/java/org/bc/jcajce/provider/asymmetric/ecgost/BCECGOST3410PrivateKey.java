...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.bc.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
   ...
   public BCECGOST3410PrivateKey(String var1, ECPrivateKeyParameters var2, BCECGOST3410PublicKey var3, org.bc.jce.spec.ECParameterSpec var4) {
      ECDomainParameters var5 = var2.getParameters();
      this.algorithm = var1;
      this.d = var2.getD();
      EllipticCurve var6;
