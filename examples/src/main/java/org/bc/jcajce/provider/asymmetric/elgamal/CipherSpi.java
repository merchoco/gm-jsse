...
import org.bc.crypto.BufferedAsymmetricBlockCipher;
import org.bc.crypto.CipherParameters;
import org.bc.crypto.Digest;
import org.bc.crypto.InvalidCipherTextException;
import org.bc.crypto.encodings.ISO9796d1Encoding;
import org.bc.crypto.encodings.OAEPEncoding;
import org.bc.crypto.encodings.PKCS1Encoding;
import org.bc.crypto.engines.ElGamalEngine;
import org.bc.crypto.params.ParametersWithRandom;
import org.bc.jcajce.provider.asymmetric.util.BaseCipherSpi;
import org.bc.jcajce.provider.util.DigestFactory;
import org.bc.jce.interfaces.ElGamalKey;
...
import org.bc.jce.provider.ElGamalUtil;
...
public class CipherSpi extends BaseCipherSpi {
   ...
   private void initFromSpec(OAEPParameterSpec var1) throws NoSuchPaddingException {
      ...
      if (var3 == null) {
         ...
         this.cipher = new BufferedAsymmetricBlockCipher(new OAEPEncoding(new ElGamalEngine(), var3, ((PSpecified)var1.getPSource()).getValue()));
         this.paramSpec = var1;
      }
   }
