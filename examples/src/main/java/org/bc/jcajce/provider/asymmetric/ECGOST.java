...
import org.bc.jcajce.provider.asymmetric.ecgost.KeyFactorySpi;
import org.bc.jcajce.provider.config.ConfigurableProvider;
import org.bc.jcajce.provider.util.AsymmetricAlgorithmProvider;

public class ECGOST {
   private static final String PREFIX = "org.bc.jcajce.provider.asymmetric.ecgost.";

   public static class Mappings extends AsymmetricAlgorithmProvider {
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("KeyFactory.ECGOST3410", "org.bc.jcajce.provider.asymmetric.ecgost.KeyFactorySpi");
         ...
         var1.addAlgorithm("KeyPairGenerator.ECGOST3410", "org.bc.jcajce.provider.asymmetric.ecgost.KeyPairGeneratorSpi");
         ...
         var1.addAlgorithm("Signature.ECGOST3410", "org.bc.jcajce.provider.asymmetric.ecgost.SignatureSpi");
         ...
         this.addSignatureAlgorithm(var1, "GOST3411", "ECGOST3410", "org.bc.jcajce.provider.asymmetric.ecgost.SignatureSpi", CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_2001);
      }
   }
}
