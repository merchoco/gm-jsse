...
import org.bc.crypto.macs.GOST28147Mac;
...
public final class GOST28147 {
   public static class AlgParamGen extends BaseAlgorithmParameterGenerator {
      ...
      protected AlgorithmParameters engineGenerateParameters() {
         ...
         try {
            AlgorithmParameters var2 = AlgorithmParameters.getInstance("GOST28147", BouncyCastleProvider.PROVIDER_NAME);
   ...
   public static class Mappings extends AlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         ...
         var1.addAlgorithm("Cipher." + CryptoProObjectIdentifiers.gostR28147_cbc, PREFIX + "$CBC");
         ...
         var1.addAlgorithm("Alg.Alias.KeyGenerator." + CryptoProObjectIdentifiers.gostR28147_cbc, "GOST28147");
