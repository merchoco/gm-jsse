...
import org.bc.asn1.pkcs.RSAESOAEPparams;
   ...
   public static class OAEP extends AlgorithmParametersSpi {
      ...
      protected void engineInit(byte[] var1) throws IOException {
         try {
            ...
            this.currentSpec = new OAEPParameterSpec(var2.getHashAlgorithm().getAlgorithm().getId(), var2.getMaskGenAlgorithm().getAlgorithm().getId(), new MGF1ParameterSpec(AlgorithmIdentifier.getInstance(var2.getMaskGenAlgorithm().getParameters()).getAlgorithm().getId()), new PSpecified(ASN1OctetString.getInstance(var2.getPSourceAlgorithm().getParameters()).getOctets()));
   ...
   public static class PSS extends AlgorithmParametersSpi {
      ...
      protected void engineInit(byte[] var1) throws IOException {
         try {
            ...
            this.currentSpec = new PSSParameterSpec(var2.getHashAlgorithm().getAlgorithm().getId(), var2.getMaskGenAlgorithm().getAlgorithm().getId(), new MGF1ParameterSpec(AlgorithmIdentifier.getInstance(var2.getMaskGenAlgorithm().getParameters()).getAlgorithm().getId()), var2.getSaltLength().intValue(), var2.getTrailerField().intValue());
         } catch (ClassCastException var3) {
