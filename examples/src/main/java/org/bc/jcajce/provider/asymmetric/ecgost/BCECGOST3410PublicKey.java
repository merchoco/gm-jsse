...
public class BCECGOST3410PublicKey implements ECPublicKey, org.bc.jce.interfaces.ECPublicKey, ECPointEncoder {
   ...
   public BCECGOST3410PublicKey(org.bc.jce.spec.ECPublicKeySpec var1) {
      this.q = var1.getQ();
   ...
   public BCECGOST3410PublicKey(String var1, ECPublicKeyParameters var2, org.bc.jce.spec.ECParameterSpec var3) {
      ECDomainParameters var4 = var2.getParameters();
      this.algorithm = var1;
      this.q = var2.getQ();
      EllipticCurve var5;
   ...
   private void populateFromPubKeyInfo(SubjectPublicKeyInfo var1) {
      byte[] var6;
      if (var1.getAlgorithm().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
         ...
         this.gostParams = new GOST3410PublicKeyAlgParameters((ASN1Sequence)var1.getAlgorithm().getParameters());
         ...
         X962Parameters var12 = new X962Parameters((ASN1Primitive)var1.getAlgorithm().getParameters());
         ECCurve var13;
         EllipticCurve var14;
