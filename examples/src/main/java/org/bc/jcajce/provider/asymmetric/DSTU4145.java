...
import org.bc.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
public class DSTU4145 {
   private static final String PREFIX = "org.bc.jcajce.provider.asymmetric.dstu.";

   public static class Mappings extends AsymmetricAlgorithmProvider {
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("KeyFactory.DSTU4145", "org.bc.jcajce.provider.asymmetric.dstu.KeyFactorySpi");
         ...
         var1.addAlgorithm("KeyPairGenerator.DSTU4145", "org.bc.jcajce.provider.asymmetric.dstu.KeyPairGeneratorSpi");
         ...
         var1.addAlgorithm("Signature.DSTU4145", "org.bc.jcajce.provider.asymmetric.dstu.SignatureSpi");
         var1.addAlgorithm("Alg.Alias.Signature.DSTU-4145", "DSTU4145");
         var1.addAlgorithm("Alg.Alias.Signature.DSTU-4145-2002", "DSTU4145");
         this.addSignatureAlgorithm(var1, "GOST3411", "DSTU4145LE", "org.bc.jcajce.provider.asymmetric.dstu.SignatureSpiLe", UAObjectIdentifiers.dstu4145le);
         this.addSignatureAlgorithm(var1, "GOST3411", "DSTU4145", "org.bc.jcajce.provider.asymmetric.dstu.SignatureSpi", UAObjectIdentifiers.dstu4145be);
      }
   }
}
