...
import org.bc.jce.MultiCertStoreParameters;
...
public class MultiCertStoreSpi extends CertStoreSpi {
   ...
   public MultiCertStoreSpi(CertStoreParameters var1) throws InvalidAlgorithmParameterException {
      ...
      if (!(var1 instanceof MultiCertStoreParameters)) {
         throw new InvalidAlgorithmParameterException("org.bc.jce.provider.MultiCertStoreSpi: parameter must be a MultiCertStoreParameters object\n" + var1.toString());
      } else {
