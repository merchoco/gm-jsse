...
public class JCEDHPublicKey implements DHPublicKey {
   ...
   JCEDHPublicKey(SubjectPublicKeyInfo var1) {
      ...
      DERInteger var2;
      try {
         var2 = (DERInteger)var1.parsePublicKey();
   ...
   public byte[] getEncoded() {
      return this.info != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(this.info) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), (ASN1Encodable)(new DERInteger(this.y)));
   }
   ...
   private boolean isPKCSParam(ASN1Sequence var1) {
      if (var1.size() == 2) {
         ...
         ASN1Integer var2 = DERInteger.getInstance(var1.getObjectAt(2));
         ASN1Integer var3 = DERInteger.getInstance(var1.getObjectAt(0));
