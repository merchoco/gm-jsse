...
public class CertPathValidatorUtilities {
      ...
      if (var1.isAdditionalLocationsEnabled()) {
         try {
            if (var0.startsWith("ldap://")) {
               ...
               var1.addAdditionalStore(X509Store.getInstance("CERTIFICATE/LDAP", var4, (String)BouncyCastleProvider.PROVIDER_NAME));
               var1.addAdditionalStore(X509Store.getInstance("CRL/LDAP", var4, (String)BouncyCastleProvider.PROVIDER_NAME));
               var1.addAdditionalStore(X509Store.getInstance("ATTRIBUTECERTIFICATE/LDAP", var4, (String)BouncyCastleProvider.PROVIDER_NAME));
               var1.addAdditionalStore(X509Store.getInstance("CERTIFICATEPAIR/LDAP", var4, (String)BouncyCastleProvider.PROVIDER_NAME));
            }
   ...
   protected static Collection findCertificates(X509CertStoreSelector var0, List var1) throws AnnotatedException {
      ...
      while(var3.hasNext()) {
         ...
         if (var4 instanceof X509Store) {
            ...
            try {
               var2.addAll(var9.getCertificates(var0));
   ...
   protected static void getCertStatus(Date var0, X509CRL var1, Object var2, CertStatus var3) throws AnnotatedException {
      ...
      if (var4.hasExtensions()) {
         try {
            var10 = DEREnumerated.getInstance(getExtensionValue(var4, org.bc.asn1.x509.X509Extension.reasonCode.getId()));
         } catch (Exception var8) {
      ...
      if (var0.getValidityModel() == 1) {
         if (var2 <= 0) {
            ...
            try {
               ...
               if (var4 != null) {
                  var3 = DERGeneralizedTime.getInstance(ASN1Primitive.fromByteArray(var4));
               }
            } catch (IOException var6) {
         ...
         if (var4.getParams() != null) {
            ...
            for(int var5 = var1 + 1; var5 < var0.size(); ++var5) {
               ...
               if (var7.getParams() != null) {
                  ...
                  try {
                     KeyFactory var10 = KeyFactory.getInstance("DSA", BouncyCastleProvider.PROVIDER_NAME);
   ...
   protected static Collection findIssuerCerts(X509Certificate var0, ExtendedPKIXBuilderParameters var1) throws AnnotatedException {
      ...
      try {
         var2.setSubject(var0.getIssuerX500Principal().getEncoded());
      } catch (IOException var7) {
         throw new AnnotatedException("Subject criteria for certificate selector to find issuer certificate could not be set.", var7);
      }
      ...
      try {
         var5 = new ArrayList();
         var5.addAll(findCertificates(var2, var1.getCertStores()));
         var5.addAll(findCertificates(var2, var1.getStores()));
         var5.addAll(findCertificates(var2, var1.getAdditionalStores()));
         var4 = var5.iterator();
      } catch (AnnotatedException var6) {
         throw new AnnotatedException("Issuer certificate cannot be searched.", var6);
      }

      var5 = null;

      while(var4.hasNext()) {
         X509Certificate var8 = (X509Certificate)var4.next();
         var3.add(var8);
      }
