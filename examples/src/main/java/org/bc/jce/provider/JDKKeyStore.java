...
import org.bc.crypto.io.DigestInputStream;
import org.bc.crypto.io.DigestOutputStream;
import org.bc.crypto.io.MacInputStream;
import org.bc.crypto.io.MacOutputStream;
...
import org.bc.util.io.TeeOutputStream;
...
public class JDKKeyStore extends KeyStoreSpi implements BCKeyStore {
   ...
   private Certificate decodeCertificate(DataInputStream var1) throws IOException {
      ...
      try {
         CertificateFactory var4 = CertificateFactory.getInstance(var2, BouncyCastleProvider.PROVIDER_NAME);
   ...
   private Key decodeKey(DataInputStream var1) throws IOException {
      ...
      try {
         switch(var2) {
         case 0:
            return KeyFactory.getInstance(var4, BouncyCastleProvider.PROVIDER_NAME).generatePrivate((KeySpec)var6);
         case 1:
            return KeyFactory.getInstance(var4, BouncyCastleProvider.PROVIDER_NAME).generatePublic((KeySpec)var6);
         case 2:
            return SecretKeyFactory.getInstance(var4, BouncyCastleProvider.PROVIDER_NAME).generateSecret((KeySpec)var6);
         default:
   ...
   protected Cipher makePBECipher(String var1, int var2, char[] var3, byte[] var4, int var5) throws IOException {
      try {
         ...
         SecretKeyFactory var7 = SecretKeyFactory.getInstance(var1, BouncyCastleProvider.PROVIDER_NAME);
         PBEParameterSpec var8 = new PBEParameterSpec(var4, var5);
         Cipher var9 = Cipher.getInstance(var1, BouncyCastleProvider.PROVIDER_NAME);
   ...
   public void engineDeleteEntry(String var1) throws KeyStoreException {
      ...
      if (var2 == null) {
         throw new KeyStoreException("no such entry as " + var1);
      } else {
   ...
   public void engineSetCertificateEntry(String var1, Certificate var2) throws KeyStoreException {
      ...
      if (var3 != null && var3.getType() != 1) {
         ...
         this.table.put(var1, new JDKKeyStore.StoreEntry(var1, var2));
      }
   }

   public void engineSetKeyEntry(String var1, byte[] var2, Certificate[] var3) throws KeyStoreException {
      this.table.put(var1, new JDKKeyStore.StoreEntry(var1, var2, var3));
   }
   ...
   public void engineSetKeyEntry(String var1, Key var2, char[] var3, Certificate[] var4) throws KeyStoreException {
      if (var2 instanceof PrivateKey && var4 == null) {
         ...
         try {
            this.table.put(var1, new JDKKeyStore.StoreEntry(var1, var2, var3, var4));
   ...
   protected void loadStore(InputStream var1) throws IOException {
      ...
      for(int var3 = var2.read(); var3 > 0; var3 = var2.read()) {
         ...
         case 1:
            ...
            this.table.put(var4, new JDKKeyStore.StoreEntry(var4, var5, 1, var11));
            break;
         case 2:
            Key var9 = this.decodeKey(var2);
            this.table.put(var4, new JDKKeyStore.StoreEntry(var4, var5, 2, var9, var7));
            break;
         case 3:
         case 4:
            byte[] var10 = new byte[var2.readInt()];
            var2.readFully(var10);
            this.table.put(var4, new JDKKeyStore.StoreEntry(var4, var5, var3, var10, var7));
            break;
         default:
   ...
   private class StoreEntry {
      ...
      StoreEntry(String var2, Key var3, char[] var4, Certificate[] var5) throws Exception {
         ...
         JDKKeyStore.this.random.nextBytes(var6);
         int var7 = 1024 + (JDKKeyStore.this.random.nextInt() & 1023);
         ...
         var9.write(var6);
         var9.writeInt(var7);
         Cipher var10 = JDKKeyStore.this.makePBECipher("PBEWithSHAAnd3-KeyTripleDES-CBC", 1, var4, var6, var7);
         CipherOutputStream var11 = new CipherOutputStream(var9, var10);
         var9 = new DataOutputStream(var11);
         JDKKeyStore.this.encodeKey(var3, var9);
         var9.close();
      ...
      Object getObject(char[] var1) throws NoSuchAlgorithmException, UnrecoverableKeyException {
         if ((var1 == null || var1.length == 0) && this.obj instanceof Key) {
            ...
            try {
               ...
               var3.readFully(var4);
               int var5 = var3.readInt();
               Cipher var6 = JDKKeyStore.this.makePBECipher("PBEWithSHAAnd3-KeyTripleDES-CBC", 2, var1, var4, var5);
               CipherInputStream var7 = new CipherInputStream(var3, var6);

               try {
                  return JDKKeyStore.this.decodeKey(new DataInputStream(var7));
                  ...
                  var3.readFully(var4);
                  var5 = var3.readInt();
                  var6 = JDKKeyStore.this.makePBECipher("BrokenPBEWithSHAAnd3-KeyTripleDES-CBC", 2, var1, var4, var5);
                  var7 = new CipherInputStream(var3, var6);
                  Key var9 = null;

                  try {
                     var9 = JDKKeyStore.this.decodeKey(new DataInputStream(var7));
                     ...
                     var3.readFully(var4);
                     var5 = var3.readInt();
                     var6 = JDKKeyStore.this.makePBECipher("OldPBEWithSHAAnd3-KeyTripleDES-CBC", 2, var1, var4, var5);
                     var7 = new CipherInputStream(var3, var6);
                     var9 = JDKKeyStore.this.decodeKey(new DataInputStream(var7));
                  }
                  ...
                  if (var9 != null) {
                     ...
                     var11.write(var4);
                     var11.writeInt(var5);
                     Cipher var12 = JDKKeyStore.this.makePBECipher("PBEWithSHAAnd3-KeyTripleDES-CBC", 1, var1, var4, var5);
                     CipherOutputStream var13 = new CipherOutputStream(var11, var12);
                     var11 = new DataOutputStream(var13);
                     JDKKeyStore.this.encodeKey(var9, var11);
                     var11.close();
