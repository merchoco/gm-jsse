...
import cn.gmssl.crypto.impl.sm2.SM2ParameterSpec;
...
import org.bc.asn1.misc.MiscObjectIdentifiers;
import org.bc.asn1.misc.NetscapeCertType;
import org.bc.asn1.misc.NetscapeRevocationURL;
import org.bc.asn1.misc.VerisignCzagExtension;
import org.bc.asn1.util.ASN1Dump;
import org.bc.asn1.x500.X500Name;
import org.bc.asn1.x500.style.RFC4519Style;
...
public class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
   ...
   public String getSigAlgName() {
      Provider var1 = Security.getProvider(BouncyCastleProvider.PROVIDER_NAME);
      if (var1 != null) {
   ...
   public final void verify(PublicKey var1, String var2) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
      String var3 = X509SignatureUtil.getSignatureName(this.c.getSignatureAlgorithm());
      Signature var4 = Signature.getInstance(var3, var2);
   ...
   private void checkSignature(PublicKey var1, Signature var2) throws CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException {
      if (!this.isAlgIdEqual(this.c.getSignatureAlgorithm(), this.c.getTBSCertificate().getSignature())) {
         ...
         AlgorithmIdentifier var4 = new AlgorithmIdentifier(new ASN1ObjectIdentifier("1.2.156.10197.1.501"));
         if (this.c.getSignatureAlgorithm().getAlgorithm().equals(var4.getAlgorithm())) {
            SM2ParameterSpec var5 = new SM2ParameterSpec("1234567812345678".getBytes(), var1);
