...
public class NetscapeCertRequest extends ASN1Object {
   ...
   public NetscapeCertRequest(ASN1Sequence var1) {
      try {
         if (var1.size() != 3) {
            ...
            this.sigAlg = new AlgorithmIdentifier((ASN1Sequence)var1.getObjectAt(1));
            this.sigBits = ((DERBitString)var1.getObjectAt(2)).getBytes();
            ...
            if (var2.size() != 2) {
               ...
               SubjectPublicKeyInfo var3 = new SubjectPublicKeyInfo((ASN1Sequence)var2.getObjectAt(0));
               X509EncodedKeySpec var4 = new X509EncodedKeySpec((new DERBitString(var3)).getBytes());
               this.keyAlg = var3.getAlgorithmId();
               this.pubkey = KeyFactory.getInstance(this.keyAlg.getObjectId().getId(), "BC").generatePublic(var4);
            }
         }
   ...
   public boolean verify(String var1) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
      if (!var1.equals(this.challenge)) {
         ...
         Signature var2 = Signature.getInstance(this.sigAlg.getObjectId().getId(), "BC");
