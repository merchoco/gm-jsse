...
public class PKCS12Util {
   ...
   public static byte[] convertToDefiniteLength(byte[] var0, char[] var1, String var2) throws IOException {
      ...
      try {
         ...
         byte[] var13 = calculatePbeMac(var10.getMac().getAlgorithmId().getObjectId(), var10.getSalt(), var11, var1, var12, var2);
         AlgorithmIdentifier var14 = new AlgorithmIdentifier(var10.getMac().getAlgorithmId().getObjectId(), DERNull.INSTANCE);
   ...
   private static byte[] calculatePbeMac(DERObjectIdentifier var0, byte[] var1, int var2, char[] var3, byte[] var4, String var5) throws Exception {
