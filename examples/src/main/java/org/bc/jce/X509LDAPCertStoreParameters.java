...
public class X509LDAPCertStoreParameters implements X509StoreParameters, CertStoreParameters {
   ...
   public int hashCode() {
      byte var1 = 0;
      int var2 = this.addHashCode(var1, this.userCertificateAttribute);
      var2 = this.addHashCode(var2, this.cACertificateAttribute);
      var2 = this.addHashCode(var2, this.crossCertificateAttribute);
      var2 = this.addHashCode(var2, this.certificateRevocationListAttribute);
      var2 = this.addHashCode(var2, this.deltaRevocationListAttribute);
      var2 = this.addHashCode(var2, this.authorityRevocationListAttribute);
      var2 = this.addHashCode(var2, this.attributeCertificateAttributeAttribute);
      var2 = this.addHashCode(var2, this.aACertificateAttribute);
      var2 = this.addHashCode(var2, this.attributeDescriptorCertificateAttribute);
      var2 = this.addHashCode(var2, this.attributeCertificateRevocationListAttribute);
      var2 = this.addHashCode(var2, this.attributeAuthorityRevocationListAttribute);
      var2 = this.addHashCode(var2, this.ldapUserCertificateAttributeName);
      var2 = this.addHashCode(var2, this.ldapCACertificateAttributeName);
      var2 = this.addHashCode(var2, this.ldapCrossCertificateAttributeName);
      var2 = this.addHashCode(var2, this.ldapCertificateRevocationListAttributeName);
      var2 = this.addHashCode(var2, this.ldapDeltaRevocationListAttributeName);
      var2 = this.addHashCode(var2, this.ldapAuthorityRevocationListAttributeName);
      var2 = this.addHashCode(var2, this.ldapAttributeCertificateAttributeAttributeName);
      var2 = this.addHashCode(var2, this.ldapAACertificateAttributeName);
      var2 = this.addHashCode(var2, this.ldapAttributeDescriptorCertificateAttributeName);
      var2 = this.addHashCode(var2, this.ldapAttributeCertificateRevocationListAttributeName);
      var2 = this.addHashCode(var2, this.ldapAttributeAuthorityRevocationListAttributeName);
      var2 = this.addHashCode(var2, this.userCertificateSubjectAttributeName);
      var2 = this.addHashCode(var2, this.cACertificateSubjectAttributeName);
      var2 = this.addHashCode(var2, this.crossCertificateSubjectAttributeName);
      var2 = this.addHashCode(var2, this.certificateRevocationListIssuerAttributeName);
      var2 = this.addHashCode(var2, this.deltaRevocationListIssuerAttributeName);
      var2 = this.addHashCode(var2, this.authorityRevocationListIssuerAttributeName);
      var2 = this.addHashCode(var2, this.attributeCertificateAttributeSubjectAttributeName);
      var2 = this.addHashCode(var2, this.aACertificateSubjectAttributeName);
      var2 = this.addHashCode(var2, this.attributeDescriptorCertificateSubjectAttributeName);
      var2 = this.addHashCode(var2, this.attributeCertificateRevocationListIssuerAttributeName);
      var2 = this.addHashCode(var2, this.attributeAuthorityRevocationListIssuerAttributeName);
      var2 = this.addHashCode(var2, this.searchForSerialNumberIn);
      return var2;
   }
   ...
   public static X509LDAPCertStoreParameters getInstance(LDAPCertStoreParameters var0) {
      ...
      X509LDAPCertStoreParameters var2 = (new X509LDAPCertStoreParameters.Builder(var1, "")).build();
      return var2;
   }

   // $FF: synthetic method
   X509LDAPCertStoreParameters(X509LDAPCertStoreParameters.Builder var1, X509LDAPCertStoreParameters var2) {
      this(var1);
   }
