...
public class McElieceParameters implements CipherParameters {
   ...
   public McElieceParameters(int var1) throws IllegalArgumentException {
      if (var1 < 1) {
   ...
   public McElieceParameters(int var1, int var2) throws IllegalArgumentException {
      if (var1 < 1) {
   ...
   public McElieceParameters(int var1, int var2, int var3) throws IllegalArgumentException {
      this.m = var1;
      if (var1 < 1) {
         throw new IllegalArgumentException("m must be positive");
      } else if (var1 > 32) {
