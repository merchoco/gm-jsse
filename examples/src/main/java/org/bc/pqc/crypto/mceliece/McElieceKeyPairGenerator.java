...
import org.bc.pqc.math.linearalgebra.Matrix;
...
public class McElieceKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
   ...
   private AsymmetricCipherKeyPair genKeyPair() {
      ...
      McEliecePublicKeyParameters var15 = new McEliecePublicKeyParameters("1.3.6.1.4.1.8301.3.1.3.4.1", this.n, this.t, var14, this.mcElieceParams.getParameters());
      McEliecePrivateKeyParameters var16 = new McEliecePrivateKeyParameters("1.3.6.1.4.1.8301.3.1.3.4.1", this.n, var11, var1, var2, var12[1], var8, var13, var5, var4, this.mcElieceParams.getParameters());
