      ...
      try {
         ...
         if (var1.length != var1[0].length) {
            ...
            for(var4 = 0; var4 < this.A.length; ++var4) {
               short var2 = GF2Field.invElem(this.A[var4][var4]);

               for(var5 = var4; var5 < 2 * this.A.length; ++var5) {
                  this.A[var4][var5] = GF2Field.multElem(this.A[var4][var5], var2);
               }
            }
            ...
            for(var4 = 0; var4 < this.A.length; ++var4) {
               for(var5 = this.A.length; var5 < 2 * this.A.length; ++var5) {
                  var3[var4][var5 - this.A.length] = this.A[var4][var5];
               }
            }
