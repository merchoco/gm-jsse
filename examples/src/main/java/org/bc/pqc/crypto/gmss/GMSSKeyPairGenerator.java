...
public class GMSSKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
   ...
   private GMSSRootCalc generateCurrentAuthpathAndRoot(byte[] var1, Vector var2, byte[] var3, int var4) {
      ...
      WinternitzOTSignature var7;
      if (var4 == this.numLayer - 1) {
         var7 = new WinternitzOTSignature(var6, this.digestProvider.get(), this.otsIndex[var4]);
         var5 = var7.getPublicKey();
      } else {
         var7 = new WinternitzOTSignature(var6, this.digestProvider.get(), this.otsIndex[var4]);
         this.currentRootSigs[var4] = var7.getSignature(var1);
   ...
   public void initialize(int var1, SecureRandom var2) {
      ...
      if (var1 <= 10) {
         ...
         var4 = new int[]{10, 10, 10, 10};
         var5 = new int[]{9, 9, 9, 3};
         var6 = new int[]{2, 2, 2, 2};
         var3 = new GMSSKeyGenerationParameters(var2, new GMSSParameters(var4.length, var4, var5, var6));
      }
