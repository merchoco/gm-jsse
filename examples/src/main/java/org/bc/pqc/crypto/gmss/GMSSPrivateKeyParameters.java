...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
   ...
   public GMSSPrivateKeyParameters(int[] var1, byte[][] var2, byte[][] var3, byte[][][] var4, byte[][][] var5, byte[][][] var6, Treehash[][] var7, Treehash[][] var8, Vector[] var9, Vector[] var10, Vector[][] var11, Vector[][] var12, GMSSLeaf[] var13, GMSSLeaf[] var14, GMSSLeaf[] var15, int[] var16, byte[][] var17, GMSSRootCalc[] var18, byte[][] var19, GMSSRootSig[] var20, GMSSParameters var21, GMSSDigestProvider var22) {
      ...
      if (this.numLayer > 1) {
         if (var13 == null) {
            ...
            for(var23 = 0; var23 < this.numLayer - 2; ++var23) {
               this.nextNextLeaf[var23] = new GMSSLeaf(var22.get(), this.otsIndex[var23 + 1], this.numLeafs[var23 + 2]);
               this.nextNextLeaf[var23].initLeafCalc(this.nextNextSeeds[var23]);
            }
         } else {
      ...
      if (var14 == null) {
         ...
         for(var23 = 0; var23 < this.numLayer - 1; ++var23) {
            this.upperLeaf[var23] = new GMSSLeaf(var22.get(), this.otsIndex[var23], this.numLeafs[var23 + 1]);
            this.upperLeaf[var23].initLeafCalc(this.currentSeeds[var23]);
         }
      } else {
   ...
   private void nextTree(int var1) {
      if (var1 > 0) {
         ...
         if (!var2) {
            ...
            if (var1 > 1) {
               this.nextNextLeaf[var1 - 1 - 1].updateLeafCalc();
            }

            this.upperLeaf[var1 - 1].updateLeafCalc();
            byte[] var4;
            if (this.minTreehash[var1 - 1] >= 0) {
               this.upperTreehashLeaf[var1 - 1].updateLeafCalc();
               ...
               try {
                  ...
                  this.currentTreehash[var1 - 1][this.minTreehash[var1 - 1]].wasFinished();
      ...
      if (var1 > 0) {
         ...
         if (this.index[var1] % var2 == 1) {
            ...
            if (this.minTreehash[var1 - 1] >= 0) {
               ...
               this.upperTreehashLeaf[var1 - 1] = new GMSSLeaf(this.digestProvider.get(), this.otsIndex[var1 - 1], var2);
               this.upperTreehashLeaf[var1 - 1].initLeafCalc(var3);
               this.upperTreehashLeaf[var1 - 1].updateLeafCalc();
            }
