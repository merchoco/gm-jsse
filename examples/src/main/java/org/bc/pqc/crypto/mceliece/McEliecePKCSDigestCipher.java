...
public class McEliecePKCSDigestCipher {
   ...
   public McEliecePKCSDigestCipher(MessageEncryptor var1, Digest var2) {
      this.mcElieceCipher = var1;
   ...
   public void init(boolean var1, CipherParameters var2) {
      ...
      if (var1 && var3.isPrivate()) {
         ...
         this.reset();
         this.mcElieceCipher.init(var1, var2);
      }
   }
   ...
   public byte[] messageEncrypt() {
      if (!this.forEncrypting) {
         ...
         try {
            var2 = this.mcElieceCipher.messageEncrypt(var1);
   ...
   public byte[] messageDecrypt(byte[] var1) {
      ...
      if (this.forEncrypting) {
         ...
         try {
            var2 = this.mcElieceCipher.messageDecrypt(var1);
         } catch (Exception var4) {
            var4.printStackTrace();
         }
