...
public class RainbowKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
   ...
   private void computePublicKey() {
      ...
      for(int var14 = 0; var14 < this.layers.length; ++var14) {
         ...
         int var19 = var5[0].length;
         int var20 = var6[0].length;
         ...
         for(int var15 = 0; var15 < var19; ++var15) {
            ...
            for(var16 = 0; var16 < var19; ++var16) {
               for(var17 = 0; var17 < var20; ++var17) {
                  var12 = var1.multVect(var5[var15][var16][var17], this.A2[var16 + var20]);
                  ...
                  var12 = var1.multVect(this.b2[var16 + var20], var12);
                  this.pub_singular[var11 + var15] = var1.addVect(var12, this.pub_singular[var11 + var15]);
                  var21 = GF2Field.multElem(var5[var15][var16][var17], this.b2[var16 + var20]);
                  this.pub_scalar[var11 + var15] = GF2Field.addElem(this.pub_scalar[var11 + var15], GF2Field.multElem(var21, this.b2[var17]));
               }
            }

            for(var16 = 0; var16 < var20; ++var16) {
               for(var17 = 0; var17 < var20; ++var17) {
                  var12 = var1.multVect(var6[var15][var16][var17], this.A2[var16]);
                  var4[var11 + var15] = var1.addSquareMatrix(var4[var11 + var15], var1.multVects(var12, this.A2[var17]));
                  var12 = var1.multVect(this.b2[var17], var12);
                  this.pub_singular[var11 + var15] = var1.addVect(var12, this.pub_singular[var11 + var15]);
                  var12 = var1.multVect(var6[var15][var16][var17], this.A2[var17]);
                  var12 = var1.multVect(this.b2[var16], var12);
                  this.pub_singular[var11 + var15] = var1.addVect(var12, this.pub_singular[var11 + var15]);
                  var21 = GF2Field.multElem(var6[var15][var16][var17], this.b2[var16]);
                  this.pub_scalar[var11 + var15] = GF2Field.addElem(this.pub_scalar[var11 + var15], GF2Field.multElem(var21, this.b2[var17]));
               }
            }

            for(var16 = 0; var16 < var20 + var19; ++var16) {
               var12 = var1.multVect(var7[var15][var16], this.A2[var16]);
               this.pub_singular[var11 + var15] = var1.addVect(var12, this.pub_singular[var11 + var15]);
               this.pub_scalar[var11 + var15] = GF2Field.addElem(this.pub_scalar[var11 + var15], GF2Field.multElem(var7[var15][var16], this.b2[var16]));
            }
