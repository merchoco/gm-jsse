package org.bc.pqc.jcajce.provider.rainbow;
...
import org.bc.pqc.asn1.RainbowPrivateKey;
import org.bc.pqc.crypto.rainbow.Layer;
import org.bc.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import org.bc.pqc.crypto.rainbow.util.RainbowUtil;
import org.bc.pqc.jcajce.spec.RainbowPrivateKeySpec;
...
public class BCRainbowPrivateKey implements PrivateKey {
   ...
   public int hashCode() {
      ...
      var1 = var1 * 37 + org.bc.util.Arrays.hashCode(this.A1inv);
      var1 = var1 * 37 + org.bc.util.Arrays.hashCode(this.b1);
      var1 = var1 * 37 + org.bc.util.Arrays.hashCode(this.A2inv);
      var1 = var1 * 37 + org.bc.util.Arrays.hashCode(this.b2);
      var1 = var1 * 37 + org.bc.util.Arrays.hashCode(this.vi);
