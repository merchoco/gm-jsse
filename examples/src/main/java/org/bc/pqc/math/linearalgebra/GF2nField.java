...
public abstract class GF2nField {
   ...
   protected final GF2Polynomial[] invertMatrix(GF2Polynomial[] var1) {
      ...
      int var5;
      for(var5 = 0; var5 < this.mDegree; ++var5) {
         try {
      ...
      int var6;
      for(var5 = 0; var5 < this.mDegree - 1; ++var5) {
         for(var6 = var5; var6 < this.mDegree && !var2[var6].testBit(this.mDegree - 1 - var5); ++var6) {
            ;
         }
         ...
         for(var6 = var5 + 1; var6 < this.mDegree; ++var6) {
            if (var2[var6].testBit(this.mDegree - 1 - var5)) {
               var2[var6].addToThis(var2[var5]);
               var3[var6].addToThis(var3[var5]);
            }
         }
      }

      for(var5 = this.mDegree - 1; var5 > 0; --var5) {
