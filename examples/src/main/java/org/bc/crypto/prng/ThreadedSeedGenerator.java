...
public class ThreadedSeedGenerator {
   public byte[] generateSeed(int var1, boolean var2) {
      ThreadedSeedGenerator.SeedGenerator var3 = new ThreadedSeedGenerator.SeedGenerator((ThreadedSeedGenerator.SeedGenerator)null);
   ...
   private class SeedGenerator implements Runnable {
      ...
      // $FF: synthetic method
      SeedGenerator(ThreadedSeedGenerator.SeedGenerator var2) {
         this();
      }
   }
}
