...
public class SHA3Digest implements ExtendedDigest {
   ...
   public void update(byte[] var1, int var2, int var3) {
      this.doUpdate(var1, var2, (long)var3 * 8L);
   }
   ...
   private void doUpdate(byte[] var1, int var2, long var3) {
      if (var3 % 8L == 0L) {
         this.absorb(var1, var2, var3);
      } else {
         this.absorb(var1, var2, var3 - var3 % 8L);
         byte[] var5 = new byte[]{(byte)(var1[var2 + (int)(var3 / 8L)] >> (int)(8L - var3 % 8L))};
         this.absorb(var5, var2, var3 % 8L);
      }
   ...
   private void absorb(byte[] var1, int var2, long var3) {
         ...
         while(true) {
            while(var5 < var3) {
               if (this.bitsInQueue == 0 && var3 >= (long)this.rate && var5 <= var3 - (long)this.rate) {
                  long var9 = (var3 - var5) / (long)this.rate;

                  for(long var7 = 0L; var7 < var9; ++var7) {
                     System.arraycopy(var1, (int)((long)var2 + var5 / 8L + var7 * (long)this.chunk.length), this.chunk, 0, this.chunk.length);
                     this.KeccakAbsorb(this.state, this.chunk, this.chunk.length);
                  }

                  var5 += var9 * (long)this.rate;
               } else {
   ...
   private void padAndSwitchToSqueezingPhase() {
      if (this.bitsInQueue + 1 == this.rate) {
         this.dataQueue[this.bitsInQueue / 8] = (byte)(this.dataQueue[this.bitsInQueue / 8] | 1 << this.bitsInQueue % 8);
         this.absorbQueue();
      ...
      this.dataQueue[(this.rate - 1) / 8] = (byte)(this.dataQueue[(this.rate - 1) / 8] | 1 << (this.rate - 1) % 8);
      this.absorbQueue();
      if (this.rate == 1024) {
   ...
   private void squeeze(byte[] var1, int var2, long var3) {
      if (!this.squeezing) {
   ...
   private void theta(long[] var1) {
      ...
      for(var2 = 0; var2 < 5; ++var2) {
         ...
         for(int var3 = 0; var3 < 5; ++var3) {
            this.C[var2] ^= var1[var2 + 5 * var3];
         }
      }

      for(var2 = 0; var2 < 5; ++var2) {
         long var6 = this.C[(var2 + 1) % 5] << 1 ^ this.C[(var2 + 1) % 5] >>> 63 ^ this.C[(var2 + 4) % 5];

         for(int var5 = 0; var5 < 5; ++var5) {
            var1[var2 + 5 * var5] ^= var6;
         }
      }
