...
public final class WhirlpoolDigest implements ExtendedDigest {
   ...
   public WhirlpoolDigest(WhirlpoolDigest var1) {
      System.arraycopy(var1._rc, 0, this._rc, 0, this._rc.length);
      System.arraycopy(var1._buffer, 0, this._buffer, 0, this._buffer.length);
      this._bufferPos = var1._bufferPos;
      System.arraycopy(var1._bitCount, 0, this._bitCount, 0, this._bitCount.length);
      System.arraycopy(var1._hash, 0, this._hash, 0, this._hash.length);
      System.arraycopy(var1._K, 0, this._K, 0, this._K.length);
      System.arraycopy(var1._L, 0, this._L, 0, this._L.length);
      System.arraycopy(var1._block, 0, this._block, 0, this._block.length);
      System.arraycopy(var1._state, 0, this._state, 0, this._state.length);
   }
   ...
   protected void processBlock() {
      ...
      for(var1 = 1; var1 <= 10; ++var1) {
         ...
         for(var2 = 0; var2 < 8; ++var2) {
            this._L[var2] = 0L;
            this._L[var2] ^= C0[(int)(this._K[var2 - 0 & 7] >>> 56) & 255];
            this._L[var2] ^= C1[(int)(this._K[var2 - 1 & 7] >>> 48) & 255];
            this._L[var2] ^= C2[(int)(this._K[var2 - 2 & 7] >>> 40) & 255];
            this._L[var2] ^= C3[(int)(this._K[var2 - 3 & 7] >>> 32) & 255];
            this._L[var2] ^= C4[(int)(this._K[var2 - 4 & 7] >>> 24) & 255];
            this._L[var2] ^= C5[(int)(this._K[var2 - 5 & 7] >>> 16) & 255];
            this._L[var2] ^= C6[(int)(this._K[var2 - 6 & 7] >>> 8) & 255];
            this._L[var2] ^= C7[(int)this._K[var2 - 7 & 7] & 255];
         }

         System.arraycopy(this._L, 0, this._K, 0, this._K.length);
         this._K[0] ^= this._rc[var1];

         for(var2 = 0; var2 < 8; ++var2) {
            this._L[var2] = this._K[var2];
            this._L[var2] ^= C0[(int)(this._state[var2 - 0 & 7] >>> 56) & 255];
            this._L[var2] ^= C1[(int)(this._state[var2 - 1 & 7] >>> 48) & 255];
            this._L[var2] ^= C2[(int)(this._state[var2 - 2 & 7] >>> 40) & 255];
            this._L[var2] ^= C3[(int)(this._state[var2 - 3 & 7] >>> 32) & 255];
            this._L[var2] ^= C4[(int)(this._state[var2 - 4 & 7] >>> 24) & 255];
            this._L[var2] ^= C5[(int)(this._state[var2 - 5 & 7] >>> 16) & 255];
            this._L[var2] ^= C6[(int)(this._state[var2 - 6 & 7] >>> 8) & 255];
            this._L[var2] ^= C7[(int)this._state[var2 - 7 & 7] & 255];
         }
      ...
      for(var1 = 0; var1 < 8; ++var1) {
         this._hash[var1] ^= this._state[var1] ^ this._block[var1];
      }
