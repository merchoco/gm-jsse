...
public class HC128Engine implements StreamCipher {
   ...
   private int step() {
      ...
      int var2;
      if (this.cnt < 512) {
         this.p[var1] += this.g1(this.p[dim(var1, 3)], this.p[dim(var1, 10)], this.p[dim(var1, 511)]);
         var2 = this.h1(this.p[dim(var1, 12)]) ^ this.p[var1];
      } else {
         this.q[var1] += this.g2(this.q[dim(var1, 3)], this.q[dim(var1, 10)], this.q[dim(var1, 511)]);
