...
public class AESEngine implements BlockCipher {
   ...
   private void encryptBlock(int[][] var1) {
      ...
      int var5;
      int var6;
      for(var2 = 1; var2 < this.ROUNDS - 1; this.C3 = T0[var6 & 255] ^ shift(T0[var3 >> 8 & 255], 24) ^ shift(T0[var4 >> 16 & 255], 16) ^ shift(T0[var5 >> 24 & 255], 8) ^ var1[var2++][3]) {
         var3 = T0[this.C0 & 255] ^ shift(T0[this.C1 >> 8 & 255], 24) ^ shift(T0[this.C2 >> 16 & 255], 16) ^ shift(T0[this.C3 >> 24 & 255], 8) ^ var1[var2][0];
         var4 = T0[this.C1 & 255] ^ shift(T0[this.C2 >> 8 & 255], 24) ^ shift(T0[this.C3 >> 16 & 255], 16) ^ shift(T0[this.C0 >> 24 & 255], 8) ^ var1[var2][1];
         var5 = T0[this.C2 & 255] ^ shift(T0[this.C3 >> 8 & 255], 24) ^ shift(T0[this.C0 >> 16 & 255], 16) ^ shift(T0[this.C1 >> 24 & 255], 8) ^ var1[var2][2];
         var6 = T0[this.C3 & 255] ^ shift(T0[this.C0 >> 8 & 255], 24) ^ shift(T0[this.C1 >> 16 & 255], 16) ^ shift(T0[this.C2 >> 24 & 255], 8) ^ var1[var2++][3];
         this.C0 = T0[var3 & 255] ^ shift(T0[var4 >> 8 & 255], 24) ^ shift(T0[var5 >> 16 & 255], 16) ^ shift(T0[var6 >> 24 & 255], 8) ^ var1[var2][0];
         this.C1 = T0[var4 & 255] ^ shift(T0[var5 >> 8 & 255], 24) ^ shift(T0[var6 >> 16 & 255], 16) ^ shift(T0[var3 >> 24 & 255], 8) ^ var1[var2][1];
         this.C2 = T0[var5 & 255] ^ shift(T0[var6 >> 8 & 255], 24) ^ shift(T0[var3 >> 16 & 255], 16) ^ shift(T0[var4 >> 24 & 255], 8) ^ var1[var2][2];
      }
   ...
   private void decryptBlock(int[][] var1) {
      ...
      int var5;
      int var6;
      for(var2 = this.ROUNDS - 1; var2 > 1; this.C3 = Tinv0[var6 & 255] ^ shift(Tinv0[var5 >> 8 & 255], 24) ^ shift(Tinv0[var4 >> 16 & 255], 16) ^ shift(Tinv0[var3 >> 24 & 255], 8) ^ var1[var2--][3]) {
         var3 = Tinv0[this.C0 & 255] ^ shift(Tinv0[this.C3 >> 8 & 255], 24) ^ shift(Tinv0[this.C2 >> 16 & 255], 16) ^ shift(Tinv0[this.C1 >> 24 & 255], 8) ^ var1[var2][0];
         var4 = Tinv0[this.C1 & 255] ^ shift(Tinv0[this.C0 >> 8 & 255], 24) ^ shift(Tinv0[this.C3 >> 16 & 255], 16) ^ shift(Tinv0[this.C2 >> 24 & 255], 8) ^ var1[var2][1];
         var5 = Tinv0[this.C2 & 255] ^ shift(Tinv0[this.C1 >> 8 & 255], 24) ^ shift(Tinv0[this.C0 >> 16 & 255], 16) ^ shift(Tinv0[this.C3 >> 24 & 255], 8) ^ var1[var2][2];
         var6 = Tinv0[this.C3 & 255] ^ shift(Tinv0[this.C2 >> 8 & 255], 24) ^ shift(Tinv0[this.C1 >> 16 & 255], 16) ^ shift(Tinv0[this.C0 >> 24 & 255], 8) ^ var1[var2--][3];
         this.C0 = Tinv0[var3 & 255] ^ shift(Tinv0[var6 >> 8 & 255], 24) ^ shift(Tinv0[var5 >> 16 & 255], 16) ^ shift(Tinv0[var4 >> 24 & 255], 8) ^ var1[var2][0];
         this.C1 = Tinv0[var4 & 255] ^ shift(Tinv0[var3 >> 8 & 255], 24) ^ shift(Tinv0[var6 >> 16 & 255], 16) ^ shift(Tinv0[var5 >> 24 & 255], 8) ^ var1[var2][1];
         this.C2 = Tinv0[var5 & 255] ^ shift(Tinv0[var4 >> 8 & 255], 24) ^ shift(Tinv0[var3 >> 16 & 255], 16) ^ shift(Tinv0[var6 >> 24 & 255], 8) ^ var1[var2][2];
      }
