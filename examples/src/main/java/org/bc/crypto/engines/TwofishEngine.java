...
public final class TwofishEngine implements BlockCipher {
   ...
   private void setKey(byte[] var1) {
      ...
      if (this.k64Cnt < 1) {
         ...
         for(var8 = 0; var8 < 20; ++var8) {
            ...
            int var7 = this.F32(var5 + 16843009, var3);
            var7 = var7 << 8 | var7 >>> 24;
            var6 += var7;
            this.gSubKeys[var8 * 2] = var6;
            var6 += var7;
            this.gSubKeys[var8 * 2 + 1] = var6 << 9 | var6 >>> 23;
         }
         ...
         for(int var16 = 0; var16 < 256; ++var16) {
            ...
            case 2:
               this.gSBox[var16 * 2] = this.gMDS0[P[0][P[0][var12] & 255 ^ this.b0(var9)] & 255 ^ this.b0(var8)];
               this.gSBox[var16 * 2 + 1] = this.gMDS1[P[0][P[1][var13] & 255 ^ this.b1(var9)] & 255 ^ this.b1(var8)];
               this.gSBox[var16 * 2 + 512] = this.gMDS2[P[1][P[0][var14] & 255 ^ this.b2(var9)] & 255 ^ this.b2(var8)];
               this.gSBox[var16 * 2 + 513] = this.gMDS3[P[1][P[1][var15] & 255 ^ this.b3(var9)] & 255 ^ this.b3(var8)];
               break;
            case 1:
               this.gSBox[var16 * 2] = this.gMDS0[P[0][var16] & 255 ^ this.b0(var8)];
               this.gSBox[var16 * 2 + 1] = this.gMDS1[P[0][var16] & 255 ^ this.b1(var8)];
               this.gSBox[var16 * 2 + 512] = this.gMDS2[P[1][var16] & 255 ^ this.b2(var8)];
               this.gSBox[var16 * 2 + 513] = this.gMDS3[P[1][var16] & 255 ^ this.b3(var8)];
            }
         }
   ...
   private void encryptBlock(byte[] var1, int var2, byte[] var3, int var4) {
      ...
      for(int var12 = 0; var12 < 16; var12 += 2) {
         ...
         var7 ^= var10 + var11 + this.gSubKeys[var9++];
         var7 = var7 >>> 1 | var7 << 31;
         var8 = (var8 << 1 | var8 >>> 31) ^ var10 + 2 * var11 + this.gSubKeys[var9++];
         var10 = this.Fe32_0(var7);
         var11 = this.Fe32_3(var8);
         var5 ^= var10 + var11 + this.gSubKeys[var9++];
         var5 = var5 >>> 1 | var5 << 31;
         var6 = (var6 << 1 | var6 >>> 31) ^ var10 + 2 * var11 + this.gSubKeys[var9++];
      }
   ...
   private void decryptBlock(byte[] var1, int var2, byte[] var3, int var4) {
      ...
      for(int var12 = 0; var12 < 16; var12 += 2) {
         int var10 = this.Fe32_0(var5);
         int var11 = this.Fe32_3(var6);
         var8 ^= var10 + 2 * var11 + this.gSubKeys[var9--];
         var7 = (var7 << 1 | var7 >>> 31) ^ var10 + var11 + this.gSubKeys[var9--];
         var8 = var8 >>> 1 | var8 << 31;
         var10 = this.Fe32_0(var7);
         var11 = this.Fe32_3(var8);
         var6 ^= var10 + 2 * var11 + this.gSubKeys[var9--];
         var5 = (var5 << 1 | var5 >>> 31) ^ var10 + var11 + this.gSubKeys[var9--];
         var6 = var6 >>> 1 | var6 << 31;
      }
