...
public class HC256Engine implements StreamCipher {
   ...
   private int step() {
      ...
      int var4;
      if (this.cnt < 1024) {
         var3 = this.p[var1 - 3 & 1023];
         var4 = this.p[var1 - 1023 & 1023];
         this.p[var1] += this.p[var1 - 10 & 1023] + (rotateRight(var3, 10) ^ rotateRight(var4, 23)) + this.q[(var3 ^ var4) & 1023];
         ...
         var3 = this.q[var1 - 3 & 1023];
         var4 = this.q[var1 - 1023 & 1023];
         this.q[var1] += this.q[var1 - 10 & 1023] + (rotateRight(var3, 10) ^ rotateRight(var4, 23)) + this.p[(var3 ^ var4) & 1023];
         var3 = this.q[var1 - 12 & 1023];
         var2 = this.p[var3 & 255] + this.p[(var3 >> 8 & 255) + 256] + this.p[(var3 >> 16 & 255) + 512] + this.p[(var3 >> 24 & 255) + 768] ^ this.q[var1];
      }
