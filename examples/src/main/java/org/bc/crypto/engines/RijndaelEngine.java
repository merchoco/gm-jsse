...
public class RijndaelEngine implements BlockCipher {
   ...
   private long[][] generateWorkingKey(byte[] var1) {
      ...
      int var10;
      for(var9 = 0; var9 < var2 && var3 < (this.ROUNDS + 1) * (this.BC / 8); ++var3) {
         for(var10 = 0; var10 < 4; ++var10) {
            var7[var3 / (this.BC / 8)][var10] |= (long)(var6[var10][var9] & 255) << var3 * 8 % this.BC;
         }
      ...
      while(var3 < (this.ROUNDS + 1) * (this.BC / 8)) {
         for(var9 = 0; var9 < 4; ++var9) {
            var6[var9][0] ^= S[var6[(var9 + 1) % 4][var2 - 1] & 255];
         }
         ...
         if (var2 <= 6) {
            for(var9 = 1; var9 < var2; ++var9) {
               for(var10 = 0; var10 < 4; ++var10) {
                  var6[var10][var9] ^= var6[var10][var9 - 1];
               }
            }
         } else {
            var9 = 1;
