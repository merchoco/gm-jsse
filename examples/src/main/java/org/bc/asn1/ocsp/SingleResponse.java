...
public class SingleResponse extends ASN1Object {
   ...
   /** @deprecated */
   public SingleResponse(CertID var1, CertStatus var2, DERGeneralizedTime var3, DERGeneralizedTime var4, Extensions var5) {
      this(var1, var2, ASN1GeneralizedTime.getInstance(var3), ASN1GeneralizedTime.getInstance(var4), Extensions.getInstance(var5));
   }
