...
public class ASN1Dump {
   ...
   static void _dumpAsString(String var0, boolean var1, ASN1Primitive var2, StringBuffer var3) {
      ...
      if (var2 instanceof ASN1Sequence) {
         ...
         if (!(var2 instanceof BEROctetString) && !(var2 instanceof BERConstructedOctetString)) {
         ...
         var3.append(var0 + "Boolean(" + ((DERBoolean)var2).isTrue() + ")" + var4);
         ...
         var3.append(var0 + "UTCTime(" + ((DERUTCTime)var2).getTime() + ") " + var4);
      } else if (var2 instanceof DERGeneralizedTime) {
         var3.append(var0 + "GeneralizedTime(" + ((DERGeneralizedTime)var2).getTime() + ") " + var4);
         ...
         DEREnumerated var12 = (DEREnumerated)var2;
   ...
   private static String outputApplicationSpecific(String var0, String var1, boolean var2, ASN1Primitive var3, String var4) {
      ...
      if (var5.isConstructed()) {
         ...
         return var1 + var0 + " ApplicationSpecific[" + var5.getApplicationTag() + "] (" + new String(Hex.encode(var5.getContents())) + ")" + var4;
      }
   }
