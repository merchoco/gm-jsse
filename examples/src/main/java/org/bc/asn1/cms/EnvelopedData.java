...
public class EnvelopedData extends ASN1Object {
   ...
   public EnvelopedData(ASN1Sequence var1) {
      ...
      this.encryptedContentInfo = EncryptedContentInfo.getInstance(var1.getObjectAt(var4++));
      if (var1.size() > var4) {
         this.unprotectedAttrs = ASN1Set.getInstance((ASN1TaggedObject)var1.getObjectAt(var4), false);
      }
