...
public class AuthenticatedData extends ASN1Object {
   ...
   public AuthenticatedData(ASN1Sequence var1) {
      ...
      if (var1.size() > var4) {
         this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject)var1.getObjectAt(var4), false);
      }
   ...
   public static AuthenticatedData getInstance(Object var0) {
      if (var0 != null && !(var0 instanceof AuthenticatedData)) {
         if (var0 instanceof ASN1Sequence) {
            return new AuthenticatedData((ASN1Sequence)var0);
         } else {
            throw new IllegalArgumentException("Invalid AuthenticatedData: " + var0.getClass().getName());
         }
      } else {
