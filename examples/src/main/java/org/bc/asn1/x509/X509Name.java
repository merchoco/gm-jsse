...
public class X509Name extends ASN1Object {
   ...
   public X509Name(boolean var1, Hashtable var2, String var3, X509NameEntryConverter var4) {
      ...
      while(var5.hasMoreTokens()) {
         ...
         ASN1ObjectIdentifier var10 = this.decodeOID(var8, var2);
         if (var9.indexOf(43) > 0) {
            X509NameTokenizer var11 = new X509NameTokenizer(var9, '+');
            String var12 = var11.nextToken();
            this.ordering.addElement(var10);
            this.values.addElement(var12);
            this.added.addElement(FALSE);
            ...
            while(var11.hasMoreTokens()) {
               ...
               this.ordering.addElement(this.decodeOID(var15, var2));
               this.values.addElement(var16);
               this.added.addElement(TRUE);
            }
         } else {
            this.ordering.addElement(var10);
            this.values.addElement(var9);
            this.added.addElement(FALSE);
         }
      }
      ...
      if (var1) {
         ...
         for(int var21 = 0; var21 < this.ordering.size(); ++var21) {
            if ((Boolean)this.added.elementAt(var21)) {
               var17.insertElementAt(this.ordering.elementAt(var21), var20);
               var18.insertElementAt(this.values.elementAt(var21), var20);
               var19.insertElementAt(this.added.elementAt(var21), var20);
               ++var20;
            } else {
               var17.insertElementAt(this.ordering.elementAt(var21), 0);
               var18.insertElementAt(this.values.elementAt(var21), 0);
               var19.insertElementAt(this.added.elementAt(var21), 0);
               var20 = 1;
            }
         }
   ...
   private void appendValue(StringBuffer var1, Hashtable var2, ASN1ObjectIdentifier var3, String var4) {
      ...
      for(; var6 != var7; ++var6) {
         if (var1.charAt(var6) == ',' || var1.charAt(var6) == '"' || var1.charAt(var6) == '\\' || var1.charAt(var6) == '+' || var1.charAt(var6) == '=' || var1.charAt(var6) == '<' || var1.charAt(var6) == '>' || var1.charAt(var6) == ';') {
            var1.insert(var6, "\\");
            ++var6;
            ++var7;
         }
