...
public class TBSCertList extends ASN1Object {
   ...
   public TBSCertList(ASN1Sequence var1) {
      if (var1.size() >= 3 && var1.size() <= 7) {
         ...
         if (var2 < var1.size() && (var1.getObjectAt(var2) instanceof DERUTCTime || var1.getObjectAt(var2) instanceof DERGeneralizedTime || var1.getObjectAt(var2) instanceof Time)) {
   ...
   public Enumeration getRevokedCertificateEnumeration() {
      return (Enumeration)(this.revokedCertificates == null ? new TBSCertList.EmptyEnumeration((TBSCertList.EmptyEnumeration)null) : new TBSCertList.RevokedCertificatesEnumeration(this.revokedCertificates.getObjects()));
   }
   ...
   private class EmptyEnumeration implements Enumeration {
      ...
      // $FF: synthetic method
      EmptyEnumeration(TBSCertList.EmptyEnumeration var2) {
         this();
      }
   }
