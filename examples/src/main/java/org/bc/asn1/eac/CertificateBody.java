...
public class CertificateBody extends ASN1Object {
   ...
   private void setIso7816CertificateBody(DERApplicationSpecific var1) throws IOException {
   ...
   private CertificateBody(DERApplicationSpecific var1) throws IOException {
   ...
   public static CertificateBody getInstance(Object var0) throws IOException {
      if (var0 instanceof CertificateBody) {
         ...
         return var0 != null ? new CertificateBody(DERApplicationSpecific.getInstance(var0)) : null;
      }
   }
