...
public class DERGeneralizedTime extends ASN1Primitive {
   ...
   public static ASN1GeneralizedTime getInstance(Object var0) {
      if (var0 != null && !(var0 instanceof ASN1GeneralizedTime)) {
         if (var0 instanceof DERGeneralizedTime) {
            return new ASN1GeneralizedTime(((DERGeneralizedTime)var0).time);
         } else if (var0 instanceof byte[]) {
            try {
               return (ASN1GeneralizedTime)fromByteArray((byte[])var0);
   ...
   public static ASN1GeneralizedTime getInstance(ASN1TaggedObject var0, boolean var1) {
      ...
      return !var1 && !(var2 instanceof DERGeneralizedTime) ? new ASN1GeneralizedTime(((ASN1OctetString)var2).getOctets()) : getInstance(var2);
   }
   ...
   boolean asn1Equals(ASN1Primitive var1) {
      return !(var1 instanceof DERGeneralizedTime) ? false : Arrays.areEqual(this.time, ((DERGeneralizedTime)var1).time);
   }
