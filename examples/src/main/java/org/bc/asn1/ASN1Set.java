...
public abstract class ASN1Set extends ASN1Primitive {
   ...
   private boolean lessThanOrEqual(byte[] var1, byte[] var2) {
      ...
      for(int var4 = 0; var4 != var3; ++var4) {
         if (var1[var4] != var2[var4]) {
            if ((var1[var4] & 255) < (var2[var4] & 255)) {
               return true;
            }
   ...
   private byte[] getEncoded(ASN1Encodable var1) {
      ...
      if (!this.isSorted) {
         ...
         if (this.set.size() > 1) {
            ...
            for(int var2 = this.set.size() - 1; var1; var2 = var4) {
               int var3 = 0;
               var4 = 0;
               byte[] var5 = this.getEncoded((ASN1Encodable)this.set.elementAt(0));

               for(var1 = false; var3 != var2; ++var3) {
                  byte[] var6 = this.getEncoded((ASN1Encodable)this.set.elementAt(var3 + 1));
