...
public class DERUTCTime extends ASN1Primitive {
   ...
   public static ASN1UTCTime getInstance(Object var0) {
      if (var0 != null && !(var0 instanceof ASN1UTCTime)) {
         if (var0 instanceof DERUTCTime) {
            return new ASN1UTCTime(((DERUTCTime)var0).time);
         } else if (var0 instanceof byte[]) {
            try {
               return (ASN1UTCTime)fromByteArray((byte[])var0);
   ...
   boolean asn1Equals(ASN1Primitive var1) {
      return !(var1 instanceof DERUTCTime) ? false : Arrays.areEqual(this.time, ((DERUTCTime)var1).time);
   }
