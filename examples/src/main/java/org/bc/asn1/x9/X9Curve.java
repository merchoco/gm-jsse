   ...
   public X9Curve(X9FieldID var1, ASN1Sequence var2) {
      ...
      if (this.fieldIdentifier.equals(prime_field)) {
         ...
         if (var13.equals(tpBasis)) {
            var14 = ((ASN1Integer)var11.getObjectAt(2)).getValue().intValue();
         } else {
            DERSequence var9 = (DERSequence)var11.getObjectAt(2);
            var14 = ((ASN1Integer)var9.getObjectAt(0)).getValue().intValue();
            var7 = ((ASN1Integer)var9.getObjectAt(1)).getValue().intValue();
            var8 = ((ASN1Integer)var9.getObjectAt(2)).getValue().intValue();
         }
