...
public interface X9ObjectIdentifiers {
   ...
   ASN1ObjectIdentifier gnBasis = id_fieldType.branch("2.3.1");
   ASN1ObjectIdentifier tpBasis = id_fieldType.branch("2.3.2");
   ASN1ObjectIdentifier ppBasis = id_fieldType.branch("2.3.3");
   ASN1ObjectIdentifier id_ecSigType = ansi_X9_62.branch("4");
   ASN1ObjectIdentifier ecdsa_with_SHA1 = new ASN1ObjectIdentifier(id_ecSigType + ".1");
