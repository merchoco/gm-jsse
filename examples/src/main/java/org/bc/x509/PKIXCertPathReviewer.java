...
import org.bc.asn1.x509.AccessDescription;
import org.bc.asn1.x509.AlgorithmIdentifier;
import org.bc.asn1.x509.AuthorityInformationAccess;
...
import org.bc.asn1.x509.qualified.Iso4217CurrencyCode;
import org.bc.asn1.x509.qualified.MonetaryValue;
import org.bc.asn1.x509.qualified.QCStatement;
import org.bc.i18n.ErrorBundle;
import org.bc.i18n.LocaleString;
import org.bc.i18n.filter.TrustedInput;
import org.bc.i18n.filter.UntrustedInput;
import org.bc.i18n.filter.UntrustedUrlInput;
import org.bc.jce.provider.AnnotatedException;
import org.bc.jce.provider.CertPathValidatorUtilities;
import org.bc.jce.provider.PKIXNameConstraintValidator;
import org.bc.jce.provider.PKIXNameConstraintValidatorException;
import org.bc.jce.provider.PKIXPolicyNode;
import org.bc.util.Integers;
import org.bc.x509.extension.X509ExtensionUtil;
...
public class PKIXCertPathReviewer extends CertPathValidatorUtilities {
   ...
   private static final String RESOURCE_NAME = "org.bc.x509.CertPathReviewerMessages";
      ...
      if (this.initialized) {
         ...
         if (var1 == null) {
            ...
            if (this.certs.isEmpty()) {
               throw new CertPathReviewerException(new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.emptyCertPath"));
            } else {
         ...
         for(int var3 = this.certs.size() - 1; var3 > 0; --var3) {
            ...
            if (!isSelfIssued(var1)) {
               ...
               try {
                  ...
                  var9 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.ncSubjectNameError", new Object[]{new UntrustedInput(var5)});
               ...
               try {
                  ...
                  var9 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.notPermittedDN", new Object[]{new UntrustedInput(var5.getName())});
               ...
               try {
                  ...
                  var9 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.excludedDN", new Object[]{new UntrustedInput(var5.getName())});
               ...
               try {
                  ...
                  ErrorBundle var10 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.subjAltNameExtError");
               ...
               if (var8 != null) {
                  for(var25 = 0; var25 < var8.size(); ++var25) {
                     ...
                     try {
                        ...
                        ErrorBundle var12 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.notPermittedEmail", new Object[]{new UntrustedInput(var26)});
            ...
            try {
               ...
               ErrorBundle var22 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.ncExtError");
   ...
   private void checkPathLength() {
      ...
      for(int var5 = this.certs.size() - 1; var5 > 0; --var5) {
         ...
         if (!isSelfIssued(var3)) {
            if (var1 <= 0) {
               ErrorBundle var6 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.pathLenghtExtended");
               this.addError(var6);
            }
         ...
         try {
            ...
            ErrorBundle var8 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.processLengthConstError");
      ...
      ErrorBundle var10 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.totalPathLength", new Object[]{Integers.valueOf(var2)});
   ...
   private void checkSignatures() {
      ...
      ErrorBundle var3 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.certPathValidDate", new Object[]{new TrustedInput(this.validDate), new TrustedInput(new Date())});
      ...
      try {
         ...
         if (var37.size() > 1) {
            var5 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.conflictingTrustAnchors", new Object[]{Integers.valueOf(var37.size()), new UntrustedInput(var35.getIssuerX500Principal())});
            this.addError(var5);
         } else if (var37.isEmpty()) {
            var5 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noTrustAnchorFound", new Object[]{new UntrustedInput(var35.getIssuerX500Principal()), Integers.valueOf(this.pkixParams.getTrustAnchors().size())});
            this.addError(var5);
         } else {
            ...
            try {
               ...
               var7 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.trustButInvalidCert");
               this.addError(var7);
         ...
         ErrorBundle var4 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.unknown", new Object[]{new UntrustedInput(var34.getMessage()), new UntrustedInput(var34)});
         this.addError(var4);
      }
      ...
      if (var1 != null) {
         ...
         try {
            ...
            var5 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.trustDNInvalid", new Object[]{new UntrustedInput(var1.getCAName())});
            this.addError(var5);
         }
         ...
         if (var35 != null) {
            ...
            if (var38 != null && !var38[5]) {
               var5 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.trustKeyUsage");
      ...
      if (var1 != null) {
         ...
         try {
            ...
            var42 = var6.getObjectId();
            var8 = var6.getParameters();
         } catch (CertPathValidatorException var29) {
            ErrorBundle var10 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.trustPubKeyError");
            this.addError(var10);
            var6 = null;
         }
      }
      ...
      for(int var11 = this.certs.size() - 1; var11 >= 0; --var11) {
         ...
         if (var36 != null) {
            try {
               ...
               var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.signatureNotVerified", new Object[]{var19.getMessage(), var19, var19.getClass().getName()});
            ...
            try {
               ...
               var12 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.rootKeyIsValidButNotATrustAnchor");
               this.addError(var12, var11);
            } catch (GeneralSecurityException var28) {
               var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.signatureNotVerified", new Object[]{var28.getMessage(), var28, var28.getClass().getName()});
               this.addError(var13, var11);
            }
         } else {
            var12 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.NoIssuerPublicKey");
            ...
            if (var45 != null) {
               try {
                  ...
                  if (var15 != null) {
                     ...
                     if (var17 != null) {
                        Object[] var18 = new Object[]{new LocaleString("org.bc.x509.CertPathReviewerMessages", "missingIssuer"), " \"", var16, "\" ", new LocaleString("org.bc.x509.CertPathReviewerMessages", "missingSerial"), " ", var17};
         ...
         try {
            ...
            var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.certificateNotYetValid", new Object[]{new TrustedInput(var9.getNotBefore())});
            this.addError(var13, var11);
         } catch (CertificateExpiredException var26) {
            var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.certificateExpired", new Object[]{new TrustedInput(var9.getNotAfter())});
            this.addError(var13, var11);
         }
         ...
         if (this.pkixParams.isRevocationEnabled()) {
            ...
            try {
               ...
               var46 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlDistPtExtError");
            ...
            try {
               ...
               ErrorBundle var52 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlAuthInfoAccError");
            ...
            ErrorBundle var56;
            while(var54.hasNext()) {
               var56 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlDistPoint", new Object[]{new UntrustedUrlInput(var54.next())});
            ...
            while(var54.hasNext()) {
               var56 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.ocspLocation", new Object[]{new UntrustedUrlInput(var54.next())});
               this.addNotification(var56, var11);
            }
         ...
         if (var39 != null && !var9.getIssuerX500Principal().equals(var39)) {
            var12 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.certWrongIssuer", new Object[]{var39.getName(), var9.getIssuerX500Principal().getName()});
            this.addError(var12, var11);
         }

         if (var43 != this.n) {
            if (var9 != null && var9.getVersion() == 1) {
               var12 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noCACert");
               this.addError(var12, var11);
            }
            ...
            try {
               ...
               if (var47 != null) {
                  if (!var47.isCA()) {
                     var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noCACert");
                     this.addError(var13, var11);
                  }
               } else {
                  var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noBasicConstraints");
                  this.addError(var13, var11);
               }
            } catch (AnnotatedException var21) {
               var46 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.errorProcesingBC");
               this.addError(var46, var11);
            }

            boolean[] var55 = var9.getKeyUsage();
            if (var55 != null && !var55[5]) {
               var46 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noCertSign");
               this.addError(var46, var11);
            }
         }
         ...
         try {
            ...
            var13 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.pubKeyError");
            this.addError(var13, var11);
            var6 = null;
            var7 = null;
            var8 = null;
      ...
      try {
         ...
         for(var10 = this.certs.size() - 1; var10 >= 0; --var10) {
            ...
            try {
               ...
               ErrorBundle var14 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyExtError");
               ...
               while(var13.hasMoreElements()) {
                  ...
                  if (!"2.5.29.32.0".equals(var16.getId())) {
                     ...
                     try {
                        ...
                        var19 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyQualifierError");
                  ...
                  while(var13.hasMoreElements()) {
                     ...
                     if ("2.5.29.32.0".equals(var15.getPolicyIdentifier().getId())) {
                        ...
                        try {
                           ...
                           ErrorBundle var61 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyQualifierError");
                        ...
                        while(true) {
                           ...
                           while(true) {
                              ...
                              while(true) {
                                 ...
                                 if (var21 instanceof DERObjectIdentifier) {
                                    var22 = ((DERObjectIdentifier)var21).getId();
                                    break;
                                 }
                              }
            ...
            if (var5 <= 0 && var4 == null) {
               var40 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noValidPolicyTree");
            ...
            if (var11 != this.n) {
               ...
               try {
                  ...
                  var53 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyMapExtError");
               ...
               if (var39 != null) {
                  ...
                  for(var47 = 0; var47 < var42.size(); ++var47) {
                     ...
                     DERObjectIdentifier var66 = (DERObjectIdentifier)var57.getObjectAt(0);
                     DERObjectIdentifier var73 = (DERObjectIdentifier)var57.getObjectAt(1);
                     if ("2.5.29.32.0".equals(var66.getId())) {
                        var19 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.invalidPolicyMapping");
               ...
               if (var39 != null) {
                  ...
                  for(var59 = 0; var59 < var42.size(); ++var59) {
                     ...
                     String var76 = ((DERObjectIdentifier)var75.getObjectAt(0)).getId();
                     String var74 = ((DERObjectIdentifier)var75.getObjectAt(1)).getId();
                  ...
                  while(var71.hasNext()) {
                     ...
                     if (var7 > 0) {
                        ...
                        try {
                           ...
                           var77 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyExtError");
                           throw new CertPathReviewerException(var77, var28, this.certPath, var10);
                        } catch (CertPathValidatorException var29) {
                           var77 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyQualifierError");
               ...
               try {
                  ...
                  if (var42 != null) {
                     ...
                     while(var65.hasMoreElements()) {
                        ...
                        case 0:
                           var59 = DERInteger.getInstance(var62, false).getValue().intValue();
                           if (var59 < var5) {
                              var5 = var59;
                           }
                           break;
                  ...
                  var53 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyConstExtError");
                  throw new CertPathReviewerException(var53, this.certPath, var10);
               }

               try {
                  DERInteger var45 = (DERInteger)getExtensionValue(var9, INHIBIT_ANY_POLICY);
                  if (var45 != null) {
                  ...
                  var53 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyInhibitExtError");
                  throw new CertPathReviewerException(var53, this.certPath, var10);
               }
            }
         }
         ...
         try {
            ...
            if (var12 != null) {
               ...
               while(var13.hasMoreElements()) {
                  ...
                  case 0:
                     var47 = DERInteger.getInstance(var46, false).getValue().intValue();
                     if (var47 == 0) {
                        var5 = 0;
                     }
                  }
            ...
            var40 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.policyConstExtError");
         ...
         if (var4 == null) {
            if (this.pkixParams.isExplicitPolicyRequired()) {
               var40 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.explicitPolicy");
               throw new CertPathReviewerException(var40, this.certPath, var10);
            }
         ...
         if (var5 <= 0 && var38 == null) {
            var40 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.invalidPolicy");
            throw new CertPathReviewerException(var40);
         }
   ...
   private void checkCriticalExtensions() {
      ...
      try {
         try {
            ...
            ErrorBundle var4 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.certPathCheckerError", new Object[]{var10.getMessage(), var10, var10.getClass().getName()});
            ...
            if (var5 != null && !var5.isEmpty()) {
               ...
               while(var6.hasNext()) {
                  try {
                     ...
                     ErrorBundle var8 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.criticalExtensionError", new Object[]{var9.getMessage(), var9, var9.getClass().getName()});
               ...
               if (!var5.isEmpty()) {
                  ...
                  while(var13.hasNext()) {
                     ErrorBundle var7 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.unknownCriticalExt", new Object[]{new DERObjectIdentifier((String)var13.next())});
      ...
      try {
         ...
         for(int var5 = 0; var5 < var13.size(); ++var5) {
            ...
            if (QCStatement.id_etsi_qcs_QcCompliance.equals(var6.getStatementId())) {
               var7 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.QcEuCompliance");
               ...
               if (QCStatement.id_etsi_qcs_QcSSCD.equals(var6.getStatementId())) {
                  var7 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.QcSSCD");
                  this.addNotification(var7, var2);
                  ...
                  double var9 = var14.getAmount().doubleValue() * Math.pow(10.0D, var14.getExponent().doubleValue());
                  ErrorBundle var11;
                  if (var14.getCurrency().isAlphabetic()) {
                     var11 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.QcLimitValueAlpha", new Object[]{var14.getCurrency().getAlphabetic(), new TrustedInput(new Double(var9)), var14});
                  } else {
                     var11 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.QcLimitValueNum", new Object[]{Integers.valueOf(var14.getCurrency().getNumeric()), new TrustedInput(new Double(var9)), var14});
                  }

                  this.addNotification(var11, var2);
               } else {
                  var7 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.QcUnknownStatement", new Object[]{var6.getStatementId(), new UntrustedInput(var6)});
                  this.addNotification(var7, var2);
                  var3 = true;
               }
            }
         ...
         ErrorBundle var4 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.QcStatementExtError");
   ...
   protected void checkCRLs(PKIXParameters var1, X509Certificate var2, Date var3, X509Certificate var4, PublicKey var5, Vector var6, int var7) throws CertPathReviewerException {
      ...
      try {
         ...
         ErrorBundle var10 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlIssuerException");
      ...
      try {
         ...
         if (var34.isEmpty()) {
            ...
            var14 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noCrlInCertstore", new Object[]{new UntrustedInput(var8.getIssuerNames()), new UntrustedInput(var12), Integers.valueOf(var13)});
            this.addNotification(var14, var7);
         }
      } catch (AnnotatedException var33) {
         ErrorBundle var11 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlExtractionError", new Object[]{var33.getCause().getMessage(), var33.getCause(), var33.getCause().getClass().getName()});
      ...
      while(var9.hasNext()) {
         ...
         if (var37.getNextUpdate() == null || var1.getDate().before(var37.getNextUpdate())) {
            var35 = true;
            var38 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.localValidCRL", new Object[]{new TrustedInput(var37.getThisUpdate()), new TrustedInput(var37.getNextUpdate())});
            this.addNotification(var38, var7);
            break;
         }

         var38 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.localInvalidCRL", new Object[]{new TrustedInput(var37.getThisUpdate()), new TrustedInput(var37.getNextUpdate())});
         this.addNotification(var38, var7);
      }
            ...
            try {
               ...
               if (var40 != null) {
                  if (!var2.getIssuerX500Principal().equals(var40.getIssuerX500Principal())) {
                     var15 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.onlineCRLWrongCA", new Object[]{new UntrustedInput(var40.getIssuerX500Principal().getName()), new UntrustedInput(var2.getIssuerX500Principal().getName()), new UntrustedUrlInput(var44)});
                     this.addNotification(var15, var7);
                  } else {
                     if (var40.getNextUpdate() == null || this.pkixParams.getDate().before(var40.getNextUpdate())) {
                        var35 = true;
                        var15 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.onlineValidCRL", new Object[]{new TrustedInput(var40.getThisUpdate()), new TrustedInput(var40.getNextUpdate()), new UntrustedUrlInput(var44)});
                        this.addNotification(var15, var7);
                        var37 = var40;
                        break;
                     }

                     var15 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.onlineInvalidCRL", new Object[]{new TrustedInput(var40.getThisUpdate()), new TrustedInput(var40.getNextUpdate()), new UntrustedUrlInput(var44)});
                     this.addNotification(var15, var7);
                  }
               }
      ...
      if (var37 != null) {
         if (var4 != null) {
            ...
            if (var41 != null && (var41.length < 7 || !var41[6])) {
               var14 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noCrlSigningPermited");
               throw new CertPathReviewerException(var14);
            }
         }

         if (var5 == null) {
            var47 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlNoIssuerPublicKey");
         ...
         try {
            ...
            var14 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlVerifyFailed");
         ...
         if (var42 != null) {
            ...
            if (var42.hasExtensions()) {
               ...
               try {
                  var45 = DEREnumerated.getInstance(getExtensionValue(var42, X509Extensions.ReasonCode.getId()));
               } catch (AnnotatedException var29) {
                  var16 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlReasonExtError");
            ...
            LocaleString var46 = new LocaleString("org.bc.x509.CertPathReviewerMessages", var43);
            if (!var3.before(var42.getRevocationDate())) {
               var15 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.certRevoked", new Object[]{new TrustedInput(var42.getRevocationDate()), var46});
               throw new CertPathReviewerException(var15);
            }

            var15 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.revokedAfterValidation", new Object[]{new TrustedInput(var42.getRevocationDate()), var46});
            this.addNotification(var15, var7);
         } else {
            var47 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.notRevoked");
            this.addNotification(var47, var7);
         }

         if (var37.getNextUpdate() != null && var37.getNextUpdate().before(this.pkixParams.getDate())) {
            var47 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlUpdateAvailable", new Object[]{new TrustedInput(var37.getNextUpdate())});
            this.addNotification(var47, var7);
         }
         ...
         try {
            ...
            var15 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.distrPtExtError");
            throw new CertPathReviewerException(var15);
         }
         ...
         try {
            ...
            var16 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.deltaCrlExtError");
         ...
         if (var48 != null) {
            ...
            try {
               ...
               var17 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlIssuerException");
               throw new CertPathReviewerException(var17, var26);
            }

            var51.setMinCRLNumber(((DERInteger)var48).getPositiveValue());

            try {
               var51.setMaxCRLNumber(((DERInteger)getExtensionValue(var37, CRL_NUMBER)).getPositiveValue().subtract(BigInteger.valueOf(1L)));
            } catch (AnnotatedException var25) {
               var17 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlNbrExtError");
            ...
            try {
               ...
               ErrorBundle var19 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlExtractionError");
            ...
            while(var53.hasNext()) {
               ...
               try {
                  ...
                  ErrorBundle var21 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.distrPtExtError");
            ...
            if (!var50) {
               var55 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noBaseCRL");
         ...
         if (var49 != null) {
            ...
            try {
               ...
               var55 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlBCExtError");
               throw new CertPathReviewerException(var55, var22);
            }

            if (var52.onlyContainsUserCerts() && var54 != null && var54.isCA()) {
               var17 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlOnlyUserCert");
               throw new CertPathReviewerException(var17);
            }

            if (var52.onlyContainsCACerts() && (var54 == null || !var54.isCA())) {
               var17 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlOnlyCaCert");
               throw new CertPathReviewerException(var17);
            }

            if (var52.onlyContainsAttributeCerts()) {
               var17 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.crlOnlyAttrCert");
               throw new CertPathReviewerException(var17);
            }
         }
      }
      ...
      if (!var35) {
         var47 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.noValidCrlFound");
         throw new CertPathReviewerException(var47);
      }
   }
   ...
   private X509CRL getCRL(String var1) throws CertPathReviewerException {
      ...
      try {
         ...
         ErrorBundle var4 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.loadCrlDistPointError", new Object[]{new UntrustedInput(var1), var6.getMessage(), var6, var6.getClass().getName()});
   ...
   protected Collection getTrustAnchors(X509Certificate var1, Set var2) throws CertPathReviewerException {
      ...
      try {
         ...
         ErrorBundle var7 = new ErrorBundle("org.bc.x509.CertPathReviewerMessages", "CertPathReviewer.trustAnchorIssuerError");
