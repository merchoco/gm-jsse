...
import org.bc.asn1.x509.TBSCertificate;
import org.bc.asn1.x509.Time;
import org.bc.asn1.x509.V3TBSCertificateGenerator;
...
public class X509V3CertificateGenerator {
   ...
   public void addExtension(String var1, boolean var2, ASN1Encodable var3) {
      this.addExtension(new DERObjectIdentifier(var1), var2, var3);
   }

   public void addExtension(DERObjectIdentifier var1, boolean var2, ASN1Encodable var3) {
   ...
   private X509Certificate generateJcaObject(TBSCertificate var1, byte[] var2) throws CertificateParsingException {
      ASN1EncodableVector var3 = new ASN1EncodableVector();
      var3.add(var1);
      var3.add(this.sigAlgId);
      var3.add(new DERBitString(var2));
      return new X509CertificateObject(Certificate.getInstance(new DERSequence(var3)));
   }
