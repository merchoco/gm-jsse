...
import org.bc.asn1.x509.V2Form;
      ...
      if (!(var1 instanceof X509Certificate)) {
         ...
         if (this.form instanceof V2Form) {
            ...
            if (var3.getBaseCertificateID() != null) {
               if (var3.getBaseCertificateID().getSerial().getValue().equals(var2.getSerialNumber()) && this.matchesDN(var2.getIssuerX500Principal(), var3.getBaseCertificateID().getIssuer())) {
                  return true;
               }
