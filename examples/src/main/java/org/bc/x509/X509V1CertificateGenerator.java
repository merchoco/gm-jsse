...
import org.bc.asn1.x509.V1TBSCertificateGenerator;
...
public class X509V1CertificateGenerator {
   ...
   public void setPublicKey(PublicKey var1) {
      try {
         this.tbsGen.setSubjectPublicKeyInfo(new SubjectPublicKeyInfo((ASN1Sequence)(new ASN1InputStream(new ByteArrayInputStream(var1.getEncoded()))).readObject()));
