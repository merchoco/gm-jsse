...
import org.bc.asn1.x509.Holder;
import org.bc.asn1.x509.IssuerSerial;
import org.bc.asn1.x509.ObjectDigestInfo;
...
public class AttributeCertificateHolder implements CertSelector, Selector {
   ...
   public AttributeCertificateHolder(int var1, String var2, String var3, byte[] var4) {
      this.holder = new Holder(new ObjectDigestInfo(var1, new ASN1ObjectIdentifier(var3), new AlgorithmIdentifier(var2), Arrays.clone(var4)));
   }
   ...
   public boolean match(Certificate var1) {
      if (!(var1 instanceof X509Certificate)) {
         ...
         try {
            ...
            } else if (this.holder.getEntityName() != null && this.matchesDN(PrincipalUtil.getSubjectX509Principal(var2), this.holder.getEntityName())) {
               return true;
            } else {
               if (this.holder.getObjectDigestInfo() != null) {
