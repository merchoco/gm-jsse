...
final class EphemeralKeyManager {
   ...
   private final EphemeralKeyManager.EphemeralKeyPair[] keys = new EphemeralKeyManager.EphemeralKeyPair[]{new EphemeralKeyManager.EphemeralKeyPair((KeyPair)null, (EphemeralKeyManager.EphemeralKeyPair)null), new EphemeralKeyManager.EphemeralKeyPair((KeyPair)null, (EphemeralKeyManager.EphemeralKeyPair)null)};
      ...
      synchronized(this.keys) {
         ...
         if (var6 == null) {
            try {
               ...
               this.keys[var4] = new EphemeralKeyManager.EphemeralKeyPair(var7.genKeyPair(), (EphemeralKeyManager.EphemeralKeyPair)null);
   ...
   private static class EphemeralKeyPair {
      ...
      // $FF: synthetic method
      EphemeralKeyPair(KeyPair var1, EphemeralKeyManager.EphemeralKeyPair var2) {
         this(var1);
      }
   }
}
