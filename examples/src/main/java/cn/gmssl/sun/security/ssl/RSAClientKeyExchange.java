...
final class RSAClientKeyExchange extends HandshakeMessage {
   ...
   RSAClientKeyExchange(ProtocolVersion var1, ProtocolVersion var2, SecureRandom var3, PublicKey var4) throws IOException {
      if (!var4.getAlgorithm().equals("RSA")) {
         ...
         byte var5;
         byte var6;
         if (!rsaPreMasterSecretFix && var2.v < ProtocolVersion.TLS11.v) {
            var5 = var1.major;
            var6 = var1.minor;
         } else {
            var5 = var2.major;
         ...
         try {
            ...
            throw (SSLKeyException)(new SSLKeyException("RSA premaster secret error")).initCause(var10);
         }
      }
   }
   ...
   RSAClientKeyExchange(ProtocolVersion var1, ProtocolVersion var2, SecureRandom var3, HandshakeInStream var4, int var5, PrivateKey var6) throws IOException {
      if (!var6.getAlgorithm().equals("RSA")) {
         ...
         try {
            ...
            var7.init(4, var6);
            this.preMaster = (SecretKey)var7.unwrap(this.encrypted, "TlsRsaPremasterSecret", 3);
            this.preMaster = this.polishPreMasterSecretKey(var1, var2, var3, this.preMaster, (Exception)null);
         } catch (Exception var8) {
            this.preMaster = this.polishPreMasterSecretKey(var1, var2, var3, (SecretKey)null, var8);
         }
